...
LOKI_METADATA_USER = os.environ.get("LOKI_METADATA_USER")
LOKI_METADATA_PASSWORD = os.environ.get("LOKI_METADATA_PASSWORD")

if not LOKI_METADATA_USER or not LOKI_METADATA_PASSWORD:
    raise RuntimeError("LOKI_METADATA_USER and LOKI_METADATA_PASSWORD environment variables are required.")
