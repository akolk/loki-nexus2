...
async def fetch_endpoint_metadata(identifier: str, client: httpx.AsyncClient) -> Optional[Dict[str, Any]]:
...
async def fetch_cbs_metadata() -> str:
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            ...
            # Pre-fetch all existing endpoints for this source for O(1) lookup
            ...
            for dataset in value:
                try:
                    ...
                    existing = endpoints_dict.get(odata_url)
                    ...
                    endpoint_metadata = await fetch_endpoint_metadata(identifier, client)
                    ...
                    if existing:
                        ...
                        endpoints_dict[odata_url] = endpoint
                        endpoints_added += 1
